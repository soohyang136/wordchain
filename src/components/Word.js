...
export default function Word(){    
    ...
    useEffect(() => {
         async function fetchData(){
            const response = await axios.get("https://cors.bridged.cc/https://opendict.korean.go.kr/api/search?certkey_no=4082&key=7C0D6B2BE5A04149309C92F60A3564B7&target_type=search&req_type=json&part=word&q="+ word[word.length - 1] + "&sort=dict&start=1&num=10");
